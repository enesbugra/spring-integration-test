package com.agaoglu.integration.integrationtestexample.config;
...
@Configuration
@EnableJpaRepositories(basePackages = { "com.agaoglu.integration.integrationtestexample" })
...
public class H2TestProfileJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.agaoglu.integration.integrationtestexample.repository"});
